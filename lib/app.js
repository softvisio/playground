...
import App from "@corejslib/app/app";
...
export default class extends App {
    ...
    async _start () {
        this.publicHttpServer.get( "/slice", async req => {
            ...
            const body = stream.Readable.from( "a".repeat( 1024 * 2 ), { "objectMode": false } );
    ...
    // curl -v "https://test.devel.softvisio.net:6666/" --insecure --haproxy-protocol
    async _testNginx () {
        var useProxyProtocol = true;
